...
coap_header[0] = (COAP_VERSION << 6) | (1 << 4) | 0  # Version, Type, Token Length
...
try:
    ...
    # Close the socket
    sock.close()
print(os.listdir('../../../Downloads/Teste_RC-P/Teste_RC-P'))
